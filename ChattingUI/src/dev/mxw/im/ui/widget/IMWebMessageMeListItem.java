...
public class IMWebMessageMeListItem extends IMMessageListItem {

	private TextView tv_title;
	private MTextView tv_content;

	public IMWebMessageMeListItem(Context context,MyInfo myinfo,OtherInfo otherinfo) {
	...
	public void setMessage(IMMessage message) {
		...
		try {
			...
			if (type == 1) {
				...
				ImageLoader.displayImage(imgURL, iv_pic,
						ImageLoader.getCommon(R.drawable.ic_launcher, R.drawable.ic_launcher, R.drawable.ic_launcher));
